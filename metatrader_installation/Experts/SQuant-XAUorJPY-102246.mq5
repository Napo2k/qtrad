...
input string CustomComment = "Strategy_2_74_188";
...
input int ATRChangesUpPeriod1 = 190;        //ATRChangesUpPeriod1
...
string sqStrategyName = "Strategy 2.74.188";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 2) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 2) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 2))), "Current");
