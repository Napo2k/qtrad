...
input string CustomComment = "Strategy_3_2_148";
...
input double ProfitTarget1 = 9.1;        //ProfitTarget1
input double StopLoss1 = 2.5;        //StopLoss1
input double TrailingStop1 = 50;        //TrailingStop1
input int SmallestRangePeriod1 = 110;        //SmallestRangePeriod1
...
string sqStrategyName = "Strategy 3.2.148";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqTimeDayOfWeek(sqTime(NULL,0, 3)) != 0);

     ShortEntrySignal = (sqTimeDayOfWeek(sqTime(NULL,0, 3)) != 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 2) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 2) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
