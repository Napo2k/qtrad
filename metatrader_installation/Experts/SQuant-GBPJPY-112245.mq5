//+------------------------------------------------------------------+
//| Strategy 1.29.159 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (netted)
//|    Generated at 07/28/2025 12:14
//| 
//|    Backtested on GBPJPY_M1_dukas / H1, 2003.08.04 - 2024.10.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_1_29_159";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 112245;        //MagicNumber
...
#define TRSMA_1 0     //iMA(NULL,0, 200, 0, MODE_SMA, PRICE_CLOSE)
#define GANNHILO_1 1     //iCustom(NULL,0,"SqGannHiLo",48)
#define BULLSPOWER_1 2     //iCustom(NULL,0, "SqBullsPower", 185, PRICE_CLOSE)
#define BEARSPOWER_1 3     //iCustom(NULL,0, "SqBearsPower", 185, PRICE_CLOSE)
#define HIGHEST_1 4     //iCustom(NULL,0, "SqHighest", 146, PRICE_OPEN)
#define BOLLINGERBANDS_1 5     //iBands(NULL,0, 20, 0, 2.0, PRICE_CLOSE)
#define LOWEST_1 6     //iCustom(NULL,0, "SqLowest", 146, PRICE_OPEN)
#define BOLLINGERBANDS_2 7     //iBands(NULL,0, 20, 0, 2, PRICE_CLOSE)
#define HEIKENASHI_1 8     //255
...
string sqStrategyName = "Strategy 1.29.159";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsUptrend(NULL,0, 0, TRSMA_1)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(GANNHILO_1, 0, 1), 6) != NormalizeDouble((double) sqDaily(NULL,0, "High", 1), 6)))
      &&   (sqIsLowerCount("sqGetIndicatorValue(BULLSPOWER_1, 0, 1)","sqTimeDayOfWeek(TimeCurrent())",7,true,3)));

     ShortEntrySignal = ((sqIsDowntrend(NULL,0, 0, TRSMA_1)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(GANNHILO_1, 0, 1), 6) == NormalizeDouble((double) sqDaily(NULL,0, "Low", 1), 6)))
      &&   (sqIsGreaterCount("sqGetIndicatorValue(BEARSPOWER_1, 0, 1)","sqTimeDayOfWeek(TimeCurrent())",7,true,3)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (0.50 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3)))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 7.0), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 1.2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetExitAfterXBars(_ticket, 40);
      }
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (0.5 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 3)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 3)))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 7), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 1.2), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[GANNHILO_1] = iCustom(NULL,0,"SqGannHiLo",48);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BULLSPOWER_1] = iCustom(NULL,0, "SqBullsPower", 185, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", 185, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 146, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, 20, 0, 2.0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 146, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 20, 0, 2, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(BULLSPOWER_1, 0, 1)") {
          return sqGetIndicatorValue(BULLSPOWER_1, 0, shift + 1);
      }
      if(id == "sqTimeDayOfWeek(TimeCurrent())") {
          return   sqTimeDayOfWeek(TimeCurrent());
      }
      if(id == "sqGetIndicatorValue(BEARSPOWER_1, 0, 1)") {
          return sqGetIndicatorValue(BEARSPOWER_1, 0, shift + 1);
      }
