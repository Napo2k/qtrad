...
input string CustomComment = "Strategy_3_98_189";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 002245;        //MagicNumber
...
input int OSMACrossZeroFstEMA1 = 8;        //OSMACrossZeroFstEMA1
input int OSMACrossZeroSlwEMA1 = 52;        //OSMACrossZeroSlwEMA1
input int OSMACrossZeroSgnPrd1 = 9;        //OSMACrossZeroSgnPrd1
input int VortexPeriod1 = 30;        //VortexPeriod1
input double PriceEntryMult1 = 2.2;        //PriceEntryMult1
input double ProfitTarget1 = 5.8;        //ProfitTarget1
input double StopLoss1 = 5.1;        //StopLoss1
...
#define OSMA_1 0     //iOsMA(NULL,0, OSMACrossZeroFstEMA1, OSMACrossZeroSlwEMA1, OSMACrossZeroSgnPrd1, PRICE_LOW)
#define AWESOMEOSCILLATOR_1 1     //iAO(NULL,0)
#define VORTEX_1 2     //iCustom(NULL,0, "SqVortex", VortexPeriod1)
#define OSMA_2 3     //iOsMA(NULL,0, OSMACrossZeroFstEMA1, OSMACrossZeroSlwEMA1, OSMACrossZeroSgnPrd1, PRICE_HIGH)
#define HIGHEST_1 4     //iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL)
#define LOWEST_1 5     //iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 3.98.189";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (crossesUp(OSMA_1, 2, 0)
      &&   (sqIsLowerCount("sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 0, 1)","sqGetIndicatorValue(VORTEX_1, 0, 1)",4,true,2)));

     ShortEntrySignal = (crossesDown(OSMA_2, 2, 0)
      &&   (sqIsGreaterCount("sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 0, 1)","sqGetIndicatorValue(VORTEX_1, 0, 1)",4,true,2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[OSMA_1] = iOsMA(NULL,0, OSMACrossZeroFstEMA1, OSMACrossZeroSlwEMA1, OSMACrossZeroSgnPrd1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[AWESOMEOSCILLATOR_1] = iAO(NULL,0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[VORTEX_1] = iCustom(NULL,0, "SqVortex", VortexPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[OSMA_2] = iOsMA(NULL,0, OSMACrossZeroFstEMA1, OSMACrossZeroSlwEMA1, OSMACrossZeroSgnPrd1, PRICE_HIGH);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 0, 1)") {
          return sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 0, shift + 1);
      }
      if(id == "sqGetIndicatorValue(VORTEX_1, 0, 1)") {
          return sqGetIndicatorValue(VORTEX_1, 0, shift + 1);
      }
