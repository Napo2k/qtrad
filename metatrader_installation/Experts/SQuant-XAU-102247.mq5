...
//| 
//|    Backtested on XAUUSD / H1, 2017.10.01 - 2025.07.28 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_4_3_138";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 102247;        //MagicNumber
...
input int SchaffTrnCycStcPrd1 = 48;        //SchaffTrnCycStcPrd1
input int SchaffTrnCycFstPrd1 = 8;        //SchaffTrnCycFstPrd1
input int SchaffTrnCycSlwPrd1 = 155;        //SchaffTrnCycSlwPrd1
input int DeMarkerPeriod1 = 14;        //DeMarkerPeriod1
input int DeMarkerPeriod2 = 40;        //DeMarkerPeriod2
input double ProfitTarget1 = 9.9;        //ProfitTarget1
input double TrailingStop1 = 31;        //TrailingStop1
...
#define SCHAFFTRENDCYCLE_1 0     //iCustom(NULL,0, "SqSchaffTrendCycle", SchaffTrnCycStcPrd1,SchaffTrnCycFstPrd1,SchaffTrnCycSlwPrd1)
#define DEMARKER_1 1     //iDeMarker(NULL,0, DeMarkerPeriod1)
#define DEMARKER_2 2     //iDeMarker(NULL,0, DeMarkerPeriod2)
...
string sqStrategyName = "Strategy 4.3.138";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsGreaterCount("sqGetIndicatorValue(SCHAFFTRENDCYCLE_1, 0, 1)","sqTimeMinute(sqTime(NULL,0, 3))",2,true,2))
      &&   (sqIsGreaterCount("sqGetIndicatorValue(DEMARKER_1, 0, 3)","sqGetIndicatorValue(DEMARKER_2, 0, 3)",8,false,2)));

     ShortEntrySignal = ((sqIsLowerCount("sqGetIndicatorValue(SCHAFFTRENDCYCLE_1, 0, 1)","sqTimeMinute(sqTime(NULL,0, 3))",2,true,2))
      &&   (sqIsLowerCount("sqGetIndicatorValue(DEMARKER_1, 0, 3)","sqGetIndicatorValue(DEMARKER_2, 0, 3)",8,false,2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqClose(NULL,0, 2), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[SCHAFFTRENDCYCLE_1] = iCustom(NULL,0, "SqSchaffTrendCycle", SchaffTrnCycStcPrd1,SchaffTrnCycFstPrd1,SchaffTrnCycSlwPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[DEMARKER_1] = iDeMarker(NULL,0, DeMarkerPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[DEMARKER_2] = iDeMarker(NULL,0, DeMarkerPeriod2);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqGetIndicatorValue(SCHAFFTRENDCYCLE_1, 0, 1)") {
          return sqGetIndicatorValue(SCHAFFTRENDCYCLE_1, 0, shift + 1);
      }
      if(id == "sqTimeMinute(sqTime(NULL,0, 3))") {
          return   sqTimeMinute(sqTime(NULL,0, shift + 3));
      }
      if(id == "sqGetIndicatorValue(DEMARKER_1, 0, 3)") {
          return sqGetIndicatorValue(DEMARKER_1, 0, shift + 3);
      }
      if(id == "sqGetIndicatorValue(DEMARKER_2, 0, 3)") {
          return sqGetIndicatorValue(DEMARKER_2, 0, shift + 3);
      }
