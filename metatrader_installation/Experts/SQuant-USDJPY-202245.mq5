...
//|    Generated at 07/29/2025 05:39
//| 
//|    Backtested on XAUUSD_M1_dukas / H1, 2003.08.04 - 2024.10.30 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_1_144";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 202245;        //MagicNumber
...
#define LINEARREGRESSION_1 4     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.1.144";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 2), 6) != NormalizeDouble((double) sqMonthly(NULL,0, "Low", 3), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(VORTEX_1, 0, 2), 6) < NormalizeDouble((double) 9.0, 6)))
      &&   (NormalizeDouble((double) sqMonthly(NULL,0, "Low", 2), 6) != NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 2), 6)));

     ShortEntrySignal = (((NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 2), 6) == NormalizeDouble((double) sqMonthly(NULL,0, "High", 3), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(VORTEX_1, 0, 2), 6) > NormalizeDouble((double) 9, 6)))
      &&   (NormalizeDouble((double) sqMonthly(NULL,0, "High", 2), 6) == NormalizeDouble((double) sqGetIndicatorValue(SMA_1, 0, 2), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LINEARREGRESSION_1, 0, 1) + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
