...
input string CustomComment = "Strategy_1_44_145";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 112246;        //MagicNumber
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", 10, PRICE_MEDIAN)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, 49, 0, 1.0, PRICE_TYPICAL)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", 10, PRICE_MEDIAN)
#define BOLLINGERBANDS_2 4     //iBands(NULL,0, 49, 0, 1, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 1.44.145";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 2) + (1.00 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1)))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 70.0), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 4.2), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 2);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 2) - (1 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1)))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 70), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 4.2), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 10, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, 49, 0, 1.0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 10, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 49, 0, 1, PRICE_TYPICAL);
