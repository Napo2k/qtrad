...
input string CustomComment = "Strategy_2_75_192";
...
input double ProfitTarget1 = 8.7;        //ProfitTarget1
input double StopLoss1 = 1;        //StopLoss1
input int MTKeltnerChannelPrd1 = 54;        //MTKeltnerChannelPrd1
...
#define MTKELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.25)
#define ATR_2 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
...
string sqStrategyName = "Strategy 2.75.192";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 3) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_2, 0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTKELTNERCHANNEL_1] = iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.25);
