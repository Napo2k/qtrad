...
input string CustomComment = "Strategy_6_15_184";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 102248;        //MagicNumber
...
input double ProfitTarget1 = 1.8;        //ProfitTarget1
input double TrailingStopCoef1 = 1.7;        //TrailingStopCoef1
...
#define ATR_1 0     //iCustom(NULL, 0, "SqATR", 110)
...
string sqStrategyName = "Strategy 6.15.184";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqTimeDayOfWeek(sqTime(NULL,0, 3)) == 1);

     ShortEntrySignal = (sqTimeDayOfWeek(sqTime(NULL,0, 3)) == 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqClose(NULL,0, 3), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 123);
...
ulong openPosition(ENUM_ORDER_TYPE type, string symbol, double volume, const double price = 0, const double slPrice = 0, const double ptPrice = 0, const int deviation = 100, const string comment = CustomComment, const int magicNo = -1, const int expiration = 0, const bool replaceExisting = true, const bool allowDuplicateTrades = true, const bool isExitLevel = false){  
