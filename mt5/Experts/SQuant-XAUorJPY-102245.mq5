...
input string CustomComment = "Strategy_4_62_140";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 102245;        //MagicNumber
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", 57, PRICE_OPEN)
#define MTATR_1 2     //iATR(NULL,0, 21)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 140)
#define LOWEST_1 4     //iCustom(NULL,0, "SqLowest", 57, PRICE_OPEN)
...
string sqStrategyName = "Strategy 4.62.140";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsFalling(ADX_1, 2, false, 2, 0);

     ShortEntrySignal = sqIsFalling(ADX_1, 2, false, 2, 0);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (0.10 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 4.6), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 5.4), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetTrailingStop(_ticket, "4.7 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (0.1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 4.6), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 5.4), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 57, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 21);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 140);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 57, PRICE_OPEN);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("4.7 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (4.7 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("4.7 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (4.7 * sqGetIndicatorValue(ATR_1, 1));
   }
