...
input string CustomComment = "Strategy_3_13_192";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 112248;        //MagicNumber
...
#define STDDEV_1 0     //iStdDev(NULL,0, 30, 0, MODE_SMA, PRICE_WEIGHTED)
#define SMA_1 1     //iMA(NULL,0, 20, 0, MODE_SMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, 20, 0, 1.9, PRICE_LOW)
#define BOLLINGERBANDS_2 3     //iBands(NULL,0, 20, 0, 1.9, PRICE_HIGH)
...
string sqStrategyName = "Strategy 3.13.192";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 1) + (1.60 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2)))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 70.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 160.0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetExitAfterXBars(_ticket, 28);
      }
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(SMA_1, 0, 1) - (1.6 * (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2)))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 70), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 160), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, 30, 0, MODE_SMA, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, 20, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, 20, 0, 1.9, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, 20, 0, 1.9, PRICE_HIGH);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("160.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 160.0));
   }
   if(idHash == sqStringHash("70.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 70.0));
   }
   if(idHash == sqStringHash("160")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 160));
   }
