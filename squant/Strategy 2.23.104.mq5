...
input string CustomComment = "Strategy_2_23_104";
...
input double TrailingActivation1 = 60;        //TrailingActivation1
input int TEMAPeriod1 = 30;        //TEMAPeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.0)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2)
#define TEMA_1 2     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 2.23.104";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_2, 1, 2+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_1, 0, 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 116);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2);
