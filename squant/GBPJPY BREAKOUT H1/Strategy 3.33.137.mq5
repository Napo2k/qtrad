...
input string CustomComment = "Strategy_3_33_137";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45696;        //MagicNumber
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", 20, 2.25)
#define LOWESTINRANGE_1 1     //iCustom(NULL,0, "SqLowestInRange", "0:00", "10:00")
#define TEMA_1 2     //iTEMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 30, 0, PRICE_CLOSE)
#define HIGHESTINRANGE_1 3     //iCustom(NULL,0, "SqHighestInRange", "0:00", "10:00")
#define MTATR_1 4     //iATR(NULL,0, 14)
#define HEIKENASHI_1 5     //255
#define HEIKENASHI_2 6     //255
#define HEIKENASHI_3 7     //255
...
string sqStrategyName = "Strategy 3.33.137";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsFalling(KELTNERCHANNEL_1, 2, false, 1, 1)
      &&   (NormalizeDouble((double) sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 2), 6) <= NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 1), 6)))
      &&   (NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 1), 6) >= NormalizeDouble((double) sqWeekly(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "Low", 2), 6)));

     ShortEntrySignal = (((sqIsRising(KELTNERCHANNEL_1, 2, false, 1, 0)
      &&   (NormalizeDouble((double) sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 2), 6)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 2), 6) >= NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 1), 6)))
      &&   (NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 1), 6) <= NormalizeDouble((double) sqWeekly(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "High", 2), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 2) + (2.10 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 85.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 270.0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 87);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 2) - (2.1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 85), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 270), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", 20, 2.25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "0:00", "10:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 30, 0, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "0:00", "10:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 14);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("270.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 270.0));
   }
   if(idHash == sqStringHash("85.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 85.0));
   }
   if(idHash == sqStringHash("270")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 270));
   }
   if(idHash == sqStringHash("85")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 85));
   }
