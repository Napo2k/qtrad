...
input string CustomComment = "Strategy_2_51_171";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45689;        //MagicNumber
...
#define ADX_2 1     //iCustom(NULL,0, "SqADX", 14)
#define ADX_3 2     //iCustom(NULL,0, "SqADX", 20)
...
string sqStrategyName = "Strategy 2.51.171";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) + (0.90 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 140.0), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) - (0.9 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 140), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_2] = iCustom(NULL,0, "SqADX", 14);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_3] = iCustom(NULL,0, "SqADX", 20);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("140")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 140));
   }
   if(idHash == sqStringHash("4.5 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (4.5 * sqGetIndicatorValue(ATR_1, 1));
   }
