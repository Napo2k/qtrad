...
input string CustomComment = "Strategy_2_34_119";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45682;        //MagicNumber
...
string sqStrategyName = "Strategy 2.34.119";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqGetBid("Same as main chart") > sqGetIndicatorValue(PARABOLICSAR_1, 1))
      &&   (NormalizeDouble((double) sqHigh(NULL,0, 1), 6) < NormalizeDouble((double) sqDaily(NULL,0, "Close", 1), 6)))
      &&   sqGetIndicatorValue(ADX_1, 3) < 20.0);

     ShortEntrySignal = (((sqGetBid("Same as main chart") < sqGetIndicatorValue(PARABOLICSAR_2, 1))
      &&   (NormalizeDouble((double) sqLow(NULL,0, 1), 6) > NormalizeDouble((double) sqDaily(NULL,0, "Close", 1), 6)))
      &&   sqGetIndicatorValue(ADX_1, 3) < 20);
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 80.0), "Current");
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 80), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", 14);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("80.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 80.0));
   }
   ...
   if(idHash == sqStringHash("80")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 80));
   }
