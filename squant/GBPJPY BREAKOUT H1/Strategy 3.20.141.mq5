...
input string CustomComment = "Strategy_3_20_141";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45692;        //MagicNumber
...
#define MTATR_1 4     //iATR(NULL,0, 40)
...
string sqStrategyName = "Strategy 3.20.141";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsFalling(KELTNERCHANNEL_1, 2, false, 1, 1)
      ...
      &&   (NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 2), 6) >= NormalizeDouble((double) sqWeekly(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "Low", 1), 6)));
     ...
     ShortEntrySignal = (((sqIsRising(KELTNERCHANNEL_1, 2, false, 1, 0)
      ...
      &&   (NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 2), 6) <= NormalizeDouble((double) sqWeekly(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "High", 1), 6)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 3) + (2.10 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 72);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 3) - (2.1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 40);
