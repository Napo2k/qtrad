...
input string CustomComment = "Strategy_3_35_100";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45694;        //MagicNumber
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", 20, 2.5)
#define KELTNERCHANNEL_2 1     //iCustom(NULL,0, "SqKeltnerChannel", 20, 2.25)
#define TEMA_1 2     //iTEMA(NULL,0, 40, 0, PRICE_TYPICAL)
#define KELTNERCHANNEL_3 3     //iCustom(NULL,0, "SqKeltnerChannel", 20, 1.5)
#define TEMA_2 4     //iTEMA(NULL,0, 50, 0, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.35.100";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((sqIsFalling(KELTNERCHANNEL_1, 2, false, 2, 1)
      &&   sqIsFalling(KELTNERCHANNEL_2, 2, false, 1, 1))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 3), 6) >= NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 3), 6)))
      &&   sqIsFalling(KELTNERCHANNEL_3, 2, false, 2, 1));

     ShortEntrySignal = (((sqIsRising(KELTNERCHANNEL_1, 2, false, 2, 0)
      &&   sqIsRising(KELTNERCHANNEL_2, 2, false, 1, 0))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TEMA_1, 0, 3), 6) <= NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 3), 6)))
      &&   sqIsRising(KELTNERCHANNEL_3, 2, false, 2, 0));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_2, 0, 2) + (2.00 * sqBiggestRange("NULL",0, 10, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 190.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 285.0), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(TEMA_2, 0, 2) - (2 * sqBiggestRange("NULL",0, 10, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 190), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 285), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", 20, 2.5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", 20, 2.25);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, 40, 0, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_3] = iCustom(NULL,0, "SqKeltnerChannel", 20, 1.5);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_2] = iTEMA(NULL,0, 50, 0, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("285.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 285.0));
   }
   if(idHash == sqStringHash("190.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 190.0));
   }
   if(idHash == sqStringHash("285")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 285));
   }
