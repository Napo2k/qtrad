...
input string CustomComment = "Strategy_4_5_103";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45679;        //MagicNumber
...
#define ROC_1 0     //iCustom(NULL,0, "SqROC", 152)
#define ROC_2 1     //iCustom(NULL,0, "SqROC", 14)
#define PARABOLICSAR_1 2     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqParabolicSAR", 0.020, 0.20)
#define ROC_3 3     //iCustom(NULL,0, "SqROC", 62)
#define ROC_4 4     //iCustom(NULL,0, "SqROC", 10)
#define MOVINGAVERAGE_1 5     //iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 50, 0, MODE_LWMA, PRICE_LOW)
#define PARABOLICSAR_2 6     //iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqParabolicSAR", 0.02, 0.2)
#define MOVINGAVERAGE_2 7     //iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 50, 0, MODE_LWMA, PRICE_HIGH)
#define MTATR_1 8     //iATR(NULL,0, 20)
#define HEIKENASHI_1 9     //255
#define HEIKENASHI_2 10     //255
#define HEIKENASHI_3 11     //255
...
string sqStrategyName = "Strategy 4.5.103";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (((((NormalizeDouble((double) sqGetIndicatorValue(ROC_1, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(ROC_2, 0, 3), 6))
      &&   (NormalizeDouble((double) sqHigh(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3), 6) < NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "High", 2), 6)))
      &&   (sqGetBid("Same as main chart") < sqGetIndicatorValue(PARABOLICSAR_1, 2)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ROC_3, 0, 2), 6) < NormalizeDouble((double) sqGetIndicatorValue(ROC_4, 0, 3), 6)))
      &&   (sqClose(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 2) < sqGetIndicatorValue(MOVINGAVERAGE_1, 2)));

     ShortEntrySignal = (((((NormalizeDouble((double) sqGetIndicatorValue(ROC_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(ROC_2, 0, 3), 6))
      &&   (NormalizeDouble((double) sqLow(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3), 6) > NormalizeDouble((double) sqDaily(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "Low", 2), 6)))
      &&   (sqGetBid("Same as main chart") > sqGetIndicatorValue(PARABOLICSAR_2, 2)))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ROC_3, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(ROC_4, 0, 3), 6)))
      &&   (sqClose(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 2) > sqGetIndicatorValue(MOVINGAVERAGE_2, 2)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 1) + (2.60 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 195.0), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 235.0), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Close", 1) - (2.6 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 195), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 235), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[ROC_1] = iCustom(NULL,0, "SqROC", 152);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ROC_2] = iCustom(NULL,0, "SqROC", 14);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqParabolicSAR", 0.020, 0.20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ROC_3] = iCustom(NULL,0, "SqROC", 62);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ROC_4] = iCustom(NULL,0, "SqROC", 10);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 50, 0, MODE_LWMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), "SqParabolicSAR", 0.02, 0.2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_2] = iMA(correctSymbol(Subchart2Symbol),TFMigrate(Subchart2Timeframe), 50, 0, MODE_LWMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 20);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("235.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 235.0));
   }
   if(idHash == sqStringHash("195.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 195.0));
   }
   if(idHash == sqStringHash("235")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 235));
   }
   if(idHash == sqStringHash("195")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 195));
   }
