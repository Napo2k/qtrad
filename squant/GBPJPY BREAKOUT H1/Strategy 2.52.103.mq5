...
input string CustomComment = "Strategy_2_52_103";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45685;        //MagicNumber
...
#define ADX_1 0     //iCustom(NULL,0, "SqADX", 40)
#define ADX_2 1     //iCustom(NULL,0, "SqADX", 97)
#define ADX_3 2     //iCustom(NULL,0, "SqADX", 14)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", 192, PRICE_CLOSE)
#define MTATR_1 4     //iATR(NULL,0, 20)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 120)
#define LOWEST_1 6     //iCustom(NULL,0, "SqLowest", 192, PRICE_CLOSE)
#define HEIKENASHI_1 7     //255
#define HEIKENASHI_2 8     //255
#define HEIKENASHI_3 9     //255
...
string sqStrategyName = "Strategy 2.52.103";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqGetIndicatorValue(ADX_1, 3) < 30.0
      &&   sqGetIndicatorValue(ADX_2, 1) < 20.0)
      &&   sqGetIndicatorValue(ADX_3, 1) < 50.0);

     ShortEntrySignal = ((sqGetIndicatorValue(ADX_1, 3) < 30
      &&   sqGetIndicatorValue(ADX_2, 1) < 20)
      &&   sqGetIndicatorValue(ADX_3, 1) < 50);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 3) + (0.90 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, 190.0), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetTrailingStop(_ticket, "4.5 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
         sqSetTSActivation(_ticket, "40.0");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 3) - (0.9 * sqGetIndicatorValue(MTATR_1, 0, 2))), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, 190), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", 40);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_2] = iCustom(NULL,0, "SqADX", 97);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_3] = iCustom(NULL,0, "SqADX", 14);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 192, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 120);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 192, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("190.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 190.0));
   }
   if(idHash == sqStringHash("4.5 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (4.5 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("40.0")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 40.0));
   }
   if(idHash == sqStringHash("340")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 340));
   }
   if(idHash == sqStringHash("190")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 190));
   }
   if(idHash == sqStringHash("4.5 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (4.5 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("40")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), 40));
   }
