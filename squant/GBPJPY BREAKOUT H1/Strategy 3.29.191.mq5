...
input string CustomComment = "Strategy_3_29_191";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 45683;        //MagicNumber
...
#define LINEARREGRESSION_1 0     //iCustom(NULL,0, "SqLinReg", 24, PRICE_CLOSE)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", 14, PRICE_OPEN)
#define TRSMA_1 2     //iMA(NULL,0, 200, 0, MODE_SMA, PRICE_CLOSE)
#define SUPERTREND_1 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqSuperTrend", 1, 48,1.6)
#define HIGHEST_1 4     //iCustom(NULL,0, "SqHighest", 14, PRICE_OPEN)
...
string sqStrategyName = "Strategy 3.29.191";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((sqClose("NULL",0, 1) > sqGetIndicatorValue(LINEARREGRESSION_1, 1))
      &&   (NormalizeDouble((double) sqMonthly(NULL,0, "Close", 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 3), 6)))
      &&   sqIsUptrend(NULL,0, 0, TRSMA_1))
      &&   (sqClose(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 0) < sqGetIndicatorValue(SUPERTREND_1, 0)));

     ShortEntrySignal = ((((sqClose("NULL",0, 1) < sqGetIndicatorValue(LINEARREGRESSION_1, 1))
      &&   (NormalizeDouble((double) sqMonthly(NULL,0, "Close", 1), 6) <= NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 3), 6)))
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqHigh(NULL,0, 1) + (2.60 * sqBarRange("NULL",0, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqLow(NULL,0, 1) - (2.6 * sqBarRange("NULL",0, 2))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", 24, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", 14, PRICE_OPEN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TRSMA_1] = iMA(NULL,0, 200, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SUPERTREND_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqSuperTrend", 1, 48,1.6);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", 14, PRICE_OPEN);
