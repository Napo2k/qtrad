//+------------------------------------------------------------------+
//| Strategy 3.30.181 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader5 (netted)
//|    Generated at 08/03/2025 14:29
//| 
//|    Backtested on J225_darwinex / H1, 2017.10.02 - 2023.09.22 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_3_30_181";
...
input int LinRegBarClosesPrd1 = 20;        //LinRegBarClosesPrd1
input double PriceEntryMult1 = 0.1;        //PriceEntryMult1
input double ProfitTarget1 = 5.4;        //ProfitTarget1
input double StopLoss1 = 35;        //StopLoss1
input int KeltnerChannelPrd1 = 20;        //KeltnerChannelPrd1
input int SmallestRangePeriod1 = 138;        //SmallestRangePeriod1
...
#define LINEARREGRESSION_1 0     //iCustom(NULL,0, "SqLinReg", LinRegBarClosesPrd1, PRICE_CLOSE)
#define KELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.6)
...
string sqStrategyName = "Strategy 3.30.181";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqClose("NULL",0, 2) < sqGetIndicatorValue(LINEARREGRESSION_1, 2));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.6);
