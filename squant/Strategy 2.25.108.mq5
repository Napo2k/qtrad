...
input string CustomComment = "Strategy_2_25_108";
...
input int ExitAfterBars1 = 18;        //ExitAfterBars1
...
string sqStrategyName = "Strategy 2.25.108";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 76);
