...
input string CustomComment = "Strategy_2_6_176";
...
input double TrailingActCef1 = 1.6;        //TrailingActCef1
input int LWMAPeriod1 = 14;        //LWMAPeriod1
...
#define LWMA_1 1     //iMA(NULL,0, LWMAPeriod1, 0, MODE_LWMA, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 60)
...
string sqStrategyName = "Strategy 2.6.176";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 3) > sqGetIndicatorValue(LINEARREGRESSION_1, 3+1));

     ShortEntrySignal = (sqOpen("NULL",0, 3) < sqGetIndicatorValue(LINEARREGRESSION_1, 3+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LWMA_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 60);
