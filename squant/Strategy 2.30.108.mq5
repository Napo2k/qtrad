...
input string CustomComment = "Strategy_2_30_108";
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 1.5)
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 165)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 95)
...
string sqStrategyName = "Strategy 2.30.108";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 158);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 1.5);
