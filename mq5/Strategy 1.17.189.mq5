...
input string CustomComment = "Strategy_1_17_189";
...
input int MACDSignalFast1 = 24;        //MACDSignalFast1
input int MACDSignalSlow1 = 26;        //MACDSignalSlow1
input int MACDSignalSmooth1 = 9;        //MACDSignalSmooth1
...
input double TrailingActCef1 = 3.9;        //TrailingActCef1
input int LinearRegressionPrd1 = 30;        //LinearRegressionPrd1
input int MTATRPeriod1 = 55;        //MTATRPeriod1
...
#define MACD_1 0     //iMACD(NULL,0, MACDSignalFast1, MACDSignalSlow1, MACDSignalSmooth1, PRICE_CLOSE)
#define LINEARREGRESSION_1 1     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_MEDIAN)
...
string sqStrategyName = "Strategy 1.17.189";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsFalling(MACD_1, 2, false, 1, 1);

     ShortEntrySignal = sqIsRising(MACD_1, 2, false, 1, 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LINEARREGRESSION_1, 0, 3) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDSignalFast1, MACDSignalSlow1, MACDSignalSmooth1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, MTATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 135);
