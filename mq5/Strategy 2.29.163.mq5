...
input string CustomComment = "Strategy_2_29_163";
...
input double TrailingStopCoef1 = 3.7;        //TrailingStopCoef1
input double TrailingActCef1 = 4.4;        //TrailingActCef1
...
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 95)
...
string sqStrategyName = "Strategy 2.29.163";
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 95);
