...
input string CustomComment = "Strategy_2_30_111";
...
input double ProfitTarget1 = 3.9;        //ProfitTarget1
...
string sqStrategyName = "Strategy 2.30.111";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (sqOpen("NULL",0, 3) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 3+1));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 86);
