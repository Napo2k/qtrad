...
input string CustomComment = "Strategy_2_19_163";
...
string sqStrategyName = "Strategy 2.19.163";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 3) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 3+1));

     ShortEntrySignal = (sqOpen("NULL",0, 3) > sqGetIndicatorValue(KELTNERCHANNEL_2, 1, 3+1));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 199);
