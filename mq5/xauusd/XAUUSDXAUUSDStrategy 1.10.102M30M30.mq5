...
input string CustomComment = "XAUUSDStrategy 1.10.102M30";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 32346;        //MagicNumber
...
input int LinRegBarClosesPrd1 = 50;        //LinRegBarClosesPrd1
input double ProfitTargetCoef1 = 3.8;        //ProfitTargetCoef1
input double StopLossCoef1 = 2;        //StopLossCoef1
input double TrailingStop1 = 6000;        //TrailingStop1
input int Period1 = 385;        //Period1
input double ProfitTargetCoef2 = 3.5;        //ProfitTargetCoef2
input double StopLossCoef2 = 2.4;        //StopLossCoef2
input int Period2 = 700;        //Period2
...
#define EMA_1 0     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_MEDIAN)
#define LINEARREGRESSION_1 1     //iCustom(NULL,0, "SqLinReg", LinRegBarClosesPrd1, PRICE_CLOSE)
...
#define LOWEST_1 5     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define ATR_3 6     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "XAUUSDStrategy 1.10.102M30";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 2), 6) < NormalizeDouble((double) sqDaily(NULL,0, "Close", 2), 6));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_3, 1)), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[EMA_1] = iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_MEDIAN);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_1] = iCustom(NULL,0, "SqLinReg", LinRegBarClosesPrd1, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef2 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (ProfitTargetCoef2 * sqGetIndicatorValue(ATR_3, 1));
   }
