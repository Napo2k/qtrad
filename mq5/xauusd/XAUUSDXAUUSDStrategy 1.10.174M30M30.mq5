...
input string CustomComment = "XAUUSDStrategy 1.10.174M30";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 32347;        //MagicNumber
...
input int EMAPeriod1 = 50;        //EMAPeriod1
input int LinRegBarClosesPrd1 = 30;        //LinRegBarClosesPrd1
...
#define EMA_1 0     //iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_OPEN)
...
string sqStrategyName = "XAUUSDStrategy 1.10.174M30";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 3), 6) < NormalizeDouble((double) sqDaily(NULL,0, "Close", 3), 6));

     ShortEntrySignal = (sqClose("NULL",0, 2) < sqGetIndicatorValue(LINEARREGRESSION_1, 2));
...
bool initIndicators(){
   ...
   indicatorHandles[EMA_1] = iMA(NULL,0, EMAPeriod1, 0, MODE_EMA, PRICE_OPEN);
