...
input string CustomComment = "XAUUSDStrategy 4.8.171M30";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 32348;        //MagicNumber
...
input int HullMovingAvrPrd1 = 24;        //HullMovingAvrPrd1
input int BBerPeriod1 = 84;        //BBerPeriod1
input int BBerPeriod2 = 20;        //BBerPeriod2
input double ProfitTargetCoef1 = 4.7;        //ProfitTargetCoef1
input double StopLossCoef1 = 2.8;        //StopLossCoef1
input int Period1 = 425;        //Period1
input double ProfitTargetCoef2 = 2.9;        //ProfitTargetCoef2
input double StopLossCoef2 = 2.5;        //StopLossCoef2
input double TrailingStopCoef1 = 2.1;        //TrailingStopCoef1
input double TrailingActivation1 = 8000;        //TrailingActivation1
...
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_CLOSE)
#define BOLLINGERBANDS_2 2     //iBands(NULL,0, BBerPeriod2, 0, 2.0, PRICE_CLOSE)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 25)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 20)
#define LOWEST_1 6     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define ATR_3 7     //iCustom(NULL, 0, "SqATR", 229)
...
string sqStrategyName = "XAUUSDStrategy 4.8.171M30";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "High", 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 2), 6));

     ShortEntrySignal = ((sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1)>sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1))
      &&   (sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2+1)<sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 2)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBerPeriod2, 0, 2.0, PRICE_CLOSE);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 229);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef2 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (ProfitTargetCoef2 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_2, 1));
   }
