//+------------------------------------------------------------------+
//| XAUUSDStrategy 1.9.103M30 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 08/17/2025 19:34
//| 
//|    Backtested on XAUUSD_M1_dukas / M30, 2006.01.01 - 2024.09.12 
//+------------------------------------------------------------------+
...
input string CustomComment = "XAUUSDStrategy 1.9.103M30";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 32345;        //MagicNumber
...
input double variable5 = 0;        //variable5
input int Period1 = 14;        //Period1
input int IchimokuKjnSenCrsBshTnkPrd1 = 9;        //IchimokuKjnSenCrsBshTnkPrd1
input int IchimokuKjnSenCrsBshKjnPrd1 = 26;        //IchimokuKjnSenCrsBshKjnPrd1
input int IchimokuKjnSenCrsBshSnkPrd1 = 148;        //IchimokuKjnSenCrsBshSnkPrd1
input int BarOpensPeriod1 = 14;        //BarOpensPeriod1
input double ProfitTargetCoef1 = 5;        //ProfitTargetCoef1
input double StopLossCoef1 = 1.9;        //StopLossCoef1
input int Period2 = 415;        //Period2
input double ProfitTargetCoef2 = 2.8;        //ProfitTargetCoef2
input double StopLossCoef2 = 2.5;        //StopLossCoef2
...
input double MainChartTickSizeSQ = 0.001; //MainChartPipSizeSQ
...
#define LOWEST_1 0     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define ICHIMOKU_1 1     //iCustom(NULL,0, "SqIchimoku", IchimokuKjnSenCrsBshTnkPrd1, IchimokuKjnSenCrsBshKjnPrd1, IchimokuKjnSenCrsBshSnkPrd1)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", BarOpensPeriod1, PRICE_TYPICAL)
#define HIGHEST_2 3     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 20)
#define LOWEST_2 5     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define ATR_2 6     //iCustom(NULL, 0, "SqATR", 30)
...
string sqStrategyName = "XAUUSDStrategy 1.9.103M30";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 2), 6) < NormalizeDouble((double) sqDaily(NULL,0, "High", 3), 6));

     ShortEntrySignal = (sqIchimokuKijunSenCross(1, NULL,0, ICHIMOKU_1, 1, 1)
      &&   (sqOpen("NULL",0, 1+1) < sqGetIndicatorValue(HIGHEST_1, 0, 1+1, true) && sqOpen("NULL",0, 1) > sqGetIndicatorValue(HIGHEST_1, 0, 1+1, true)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(HIGHEST_2, 0, 1), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(LOWEST_2, 0, 1), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, StopLossCoef2 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef2 * sqGetIndicatorValue(ATR_2, 1)), "Current");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (ShortExitSignal
      &&   sqMarketPositionIsShort(MagicNumber, "Current", ""))
)
   {
      // Action #1
      sqCloseFirstTrade(MagicNumber, "Current", -1, "");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_1] = iCustom(NULL,0, "SqIchimoku", IchimokuKjnSenCrsBshTnkPrd1, IchimokuKjnSenCrsBshKjnPrd1, IchimokuKjnSenCrsBshSnkPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", BarOpensPeriod1, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 20);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_2] = iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef2 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (ProfitTargetCoef2 * sqGetIndicatorValue(ATR_2, 1));
   }
   if(idHash == sqStringHash("StopLossCoef2 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (StopLossCoef2 * sqGetIndicatorValue(ATR_1, 1));
   }
