...
input string CustomComment = "Strategy_2_10_186";
...
input double ProfitTarget1 = 3.5;        //ProfitTarget1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 0.8)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_OPEN)
...
string sqStrategyName = "Strategy 2.10.186";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 2) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2+1));

     ShortEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 3) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 3) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 0.8);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 1.9, PRICE_OPEN);
