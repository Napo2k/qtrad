...
input string CustomComment = "Strategy_1_22_146";
...
input int MACDSignalFast1 = 12;        //MACDSignalFast1
input int MACDSignalSlow1 = 26;        //MACDSignalSlow1
input int MACDSignalSmooth1 = 16;        //MACDSignalSmooth1
...
string sqStrategyName = "Strategy 1.22.146";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsFalling(MACD_1, 2, false, 2, 1);

     ShortEntrySignal = sqIsRising(MACD_1, 2, false, 2, 1);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqOpen(NULL,0, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
