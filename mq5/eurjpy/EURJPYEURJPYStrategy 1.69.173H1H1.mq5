...
input string CustomComment = "EURJPYEURJPYStrategy_1_69_173H";
...
input int BarOpensPeriod1 = 30;        //BarOpensPeriod1
input double PriceEntryMult1 = 1.6;        //PriceEntryMult1
input double ProfitTarget1 = 200;        //ProfitTarget1
input double StopLoss1 = 65;        //StopLoss1
input double TrailingStopCoef1 = 4.2;        //TrailingStopCoef1
...
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 65)
...
string sqStrategyName = "EURJPYStrategy 1.69.173H1";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 90);
