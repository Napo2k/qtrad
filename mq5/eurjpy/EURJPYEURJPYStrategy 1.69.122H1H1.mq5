...
input string CustomComment = "EURJPYEURJPYStrategy_1_69_122H";
...
input int BarOpensPeriod1 = 13;        //BarOpensPeriod1
input double PriceEntryMult1 = 0.1;        //PriceEntryMult1
input double ProfitTarget1 = 195;        //ProfitTarget1
...
string sqStrategyName = "EURJPYStrategy 1.69.122H1";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 2+1) > sqGetIndicatorValue(LOWEST_1, 0, 2+1, true) && sqOpen("NULL",0, 2) < sqGetIndicatorValue(LOWEST_1, 0, 2+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 2+1) < sqGetIndicatorValue(HIGHEST_1, 0, 2+1, true) && sqOpen("NULL",0, 2) > sqGetIndicatorValue(HIGHEST_1, 0, 2+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 31);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetAsk("Current") - (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 2))), "Current");
