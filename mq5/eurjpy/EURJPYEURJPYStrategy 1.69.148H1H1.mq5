...
input string CustomComment = "EURJPYEURJPYStrategy_1_69_148H";
...
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 150)
...
string sqStrategyName = "EURJPYStrategy 1.69.148H1";
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 2) - (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 150);
