...
input string CustomComment = "EURJPYEURJPYStrategy_1_69_118H";
...
input int BarOpensPeriod1 = 10;        //BarOpensPeriod1
...
string sqStrategyName = "EURJPYStrategy 1.69.118H1";
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 113);
