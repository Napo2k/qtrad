//+------------------------------------------------------------------+
//| EURJPYStrategy 1.69.189H1 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader4
//|    Generated at 08/17/2025 19:31
//| 
//|    Backtested on EURJPY_M1_UTC2 / H1, 2003.08.04 - 2025.08.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "EURJPYEURJPYStrategy_1_69_189H";
...
input int BarOpensPeriod1 = 40;        //BarOpensPeriod1
input int ExitAfterBars1 = 48;        //ExitAfterBars1
input double ProfitTarget1 = 3;        //ProfitTarget1
...
#define LOWEST_1 0     //iCustom(NULL,0, "SqLowest", BarOpensPeriod1, PRICE_LOW)
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", BarOpensPeriod1, PRICE_HIGH)
#define TEMA_1 2     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_LOW)
#define TEMA_2 3     //iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_HIGH)
...
string sqStrategyName = "EURJPYStrategy 1.69.189H1";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 3+1) > sqGetIndicatorValue(LOWEST_1, 0, 3+1, true) && sqOpen("NULL",0, 3) < sqGetIndicatorValue(LOWEST_1, 0, 3+1, true));

     ShortEntrySignal = (sqOpen("NULL",0, 3+1) < sqGetIndicatorValue(HIGHEST_1, 0, 3+1, true) && sqOpen("NULL",0, 3) > sqGetIndicatorValue(HIGHEST_1, 0, 3+1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(TEMA_1, 0, 1), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 100);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(TEMA_2, 0, 1), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[LOWEST_1] = iCustom(NULL,0, "SqLowest", BarOpensPeriod1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", BarOpensPeriod1, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_1] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TEMA_2] = iTEMA(NULL,0, TEMAPeriod1, 0, PRICE_HIGH);
