...
input string CustomComment = "Strategy_4_16_172";
...
input int ATRRisingPeriod1 = 14;        //ATRRisingPeriod1
...
#define ATR_1 0     //iCustom(NULL,0, "SqATR", ATRRisingPeriod1)
#define MACD_1 1     //iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE)
#define ATR_2 2     //iCustom(NULL, 0, "SqATR", 35)
...
string sqStrategyName = "Strategy 4.16.172";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(ATR_1, 2, false, 1)
      &&   sqGetIndicatorValue(MACD_1, 0, 3, true) > sqGetIndicatorValue(MACD_1, 1, 3, true));

     ShortEntrySignal = (sqIsRising(ATR_1, 2, false, 1)
      &&   sqGetIndicatorValue(MACD_1, 0, 3, true) < sqGetIndicatorValue(MACD_1, 1, 3, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetAsk("Current") + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 35);
