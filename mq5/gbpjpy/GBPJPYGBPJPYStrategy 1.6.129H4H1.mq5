...
input string CustomComment = "GBPJPYStrategy 1.6.129H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22348;        //MagicNumber
...
input int KERbelowLevelPeriod1 = 10;        //KERbelowLevelPeriod1
input double ProfitTarget1 = 2.3;        //ProfitTarget1
input double StopLoss1 = 1.1;        //StopLoss1
input int Period1 = 110;        //Period1
input double ProfitTarget2 = 6.1;        //ProfitTarget2
...
string sqStrategyName = "GBPJPYStrategy 1.6.129H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(KAUFMANEFFICIENCYRATIO_1, 2) < 0.65);

     ShortEntrySignal = ((NormalizeDouble((double) sqWeekly(NULL,0, "Low", 2), 6) <= NormalizeDouble((double) sqWeekly(NULL,0, "Low", 2), 6))
      &&   indyCrossesAbove("sqDaily(NULL,0,\"Open\", 2)", "sqDaily(NULL,0,\"Open\", 1)", 0, 0, 0, 0));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 165);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqDaily(NULL,0,\"Open\", 2)") {
          return   sqDaily(NULL,0, "Open", shift + 2);
      }
      if(id == "sqDaily(NULL,0,\"Open\", 1)") {
          return   sqDaily(NULL,0, "Open", shift + 1);
      }
