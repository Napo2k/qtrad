...
input string CustomComment = "GBPJPYStrategy 2.10.192H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22352;        //MagicNumber
...
input double ProfitTarget2 = 180;        //ProfitTarget2
input double StopLoss2 = 2;        //StopLoss2
input double TrailingStop1 = 50;        //TrailingStop1
input int Period2 = 625;        //Period2
...
string sqStrategyName = "GBPJPYStrategy 2.10.192H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "High", 3), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "Close", 3), 6));

     ShortEntrySignal = (sqOpen("NULL",0, 3+1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1, true) && sqOpen("NULL",0, 3) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 3+1, true));
