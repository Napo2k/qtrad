...
input string CustomComment = "GBPJPYStrategy 2.10.144H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22351;        //MagicNumber
...
input int KERbelowLevelPeriod1 = 5;        //KERbelowLevelPeriod1
input int Period1 = 25;        //Period1
input double ProfitTarget1 = 360;        //ProfitTarget1
input double StopLoss1 = 1.3;        //StopLoss1
input int Period2 = 60;        //Period2
input double ProfitTarget2 = 8.8;        //ProfitTarget2
input double StopLoss2 = 140;        //StopLoss2
input double TrailingStopCoef1 = 4.3;        //TrailingStopCoef1
...
#define KAUFMANEFFICIENCYRATIO_1 0     //iCustom(NULL,0,"SqEfficiencyRatio",KERbelowLevelPeriod1)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period1, PRICE_HIGH)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE)
#define LOWEST_2 3     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 45)
...
string sqStrategyName = "GBPJPYStrategy 2.10.144H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(KAUFMANEFFICIENCYRATIO_1, 2) < 0.40);

     ShortEntrySignal = indyCrossesAbove(LOWEST_1, "sqMonthly(NULL,0,\"Close\", 3)", 2, 0, 0, 0);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         // order was successfuly placed, set or initialize all its exit methods (SL, PT, Trailing Stop, Exit After Bars, etc.)
         sqSetOrderExpiration(_ticket, 139);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(NULL,0, "SqHighest", Period2, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqMonthly(NULL,0,\"Close\", 3)") {
          return   sqMonthly(NULL,0, "Close", shift + 3);
      }
