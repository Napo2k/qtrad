...
input string CustomComment = "GBPJPYStrategy 1.9.108H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22349;        //MagicNumber
...
input int Period1 = 60;        //Period1
input double ProfitTarget2 = 315;        //ProfitTarget2
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarClosesPeriod1, 0, 1.0, PRICE_CLOSE)
...
string sqStrategyName = "GBPJPYStrategy 1.9.108H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqClose("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2));

     ShortEntrySignal = ((sqClose("NULL",0, 1) < sqGetIndicatorValue(BOLLINGERBANDS_2, 1, 1))
      &&   indyCrossesAbove("sqDaily(NULL,0,\"Close\", 2)", "sqDaily(NULL,0,\"Open\", 3)", 0, 0, 0, 0));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 55);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarClosesPeriod1, 0, 1.0, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqDaily(NULL,0,\"Close\", 2)") {
          return   sqDaily(NULL,0, "Close", shift + 2);
      }
