...
input string CustomComment = "GBPJPYStrategy 1.3.111H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22345;        //MagicNumber
...
input int BBBarOpensPeriod1 = 125;        //BBBarOpensPeriod1
input double ProfitTarget1 = 2.8;        //ProfitTarget1
input double StopLoss1 = 155;        //StopLoss1
input int Period1 = 190;        //Period1
input double ProfitTarget2 = 340;        //ProfitTarget2
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 1.3, PRICE_CLOSE)
#define HIGHESTINRANGE_1 1     //iCustom(NULL,0, "SqHighestInRange", "23:00", "3:00")
#define HIGHEST_2 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
...
string sqStrategyName = "GBPJPYStrategy 1.3.111H4";
...
if (_sqIsBarOpen == true) {
     ...
     ShortEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) >= NormalizeDouble((double) sqGetIndicatorValue(HIGHESTINRANGE_1, 0, 1), 6));
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, ProfitTarget2), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 1.3, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHESTINRANGE_1] = iCustom(NULL,0, "SqHighestInRange", "23:00", "3:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_2] = iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTarget2")) {
      return (sqConvertToRealPips(PositionGetString(POSITION_SYMBOL), ProfitTarget2));
   }
