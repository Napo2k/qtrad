...
input string CustomComment = "GBPJPYStrategy 1.5.107H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22346;        //MagicNumber
...
input int KERbelowLevelPeriod1 = 12;        //KERbelowLevelPeriod1
input double ProfitTarget1 = 2.3;        //ProfitTarget1
input double StopLoss1 = 1.1;        //StopLoss1
input int Period1 = 30;        //Period1
input double ProfitTarget2 = 185;        //ProfitTarget2
input int Period2 = 110;        //Period2
...
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
...
string sqStrategyName = "GBPJPYStrategy 1.5.107H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(KAUFMANEFFICIENCYRATIO_1, 2) < 0.20);

     ShortEntrySignal = ((NormalizeDouble((double) sqWeekly(NULL,0, "Low", 2), 6) <= NormalizeDouble((double) sqWeekly(NULL,0, "Low", 1), 6))
      &&   indyCrossesAbove("sqWeekly(NULL,0,\"High\", 1)", "sqDaily(NULL,0,\"Open\", 3)", 0, 0, 0, 0));
...
double sqGetExpressionByIdentification(string id, int shift) {
      ...
      if(id == "sqDaily(NULL,0,\"Open\", 3)") {
          return   sqDaily(NULL,0, "Open", shift + 3);
      }
