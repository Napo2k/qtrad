...
input string CustomComment = "GBPJPYStrategy 4.5.158H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22356;        //MagicNumber
...
input int VortexPeriod1 = 12;        //VortexPeriod1
input double ProfitTarget1 = 345;        //ProfitTarget1
input double StopLoss1 = 115;        //StopLoss1
input double TrailingStopCoef1 = 2;        //TrailingStopCoef1
input double TrailingActCef1 = 2.8;        //TrailingActCef1
input int Period1 = 95;        //Period1
input double ProfitTarget2 = 7.3;        //ProfitTarget2
input double StopLoss2 = 160;        //StopLoss2
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.25)
#define VORTEX_1 1     //iCustom(NULL,0, "SqVortex", VortexPeriod1)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 35)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 125)
...
string sqStrategyName = "GBPJPYStrategy 4.5.158H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "High", 3), 6));

     ShortEntrySignal = indyCrossesAbove(VORTEX_1, "1.0", 1, 0, 1, 0);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         // order was successfuly placed, set or initialize all its exit methods (SL, PT, Trailing Stop, Exit After Bars, etc.)
         sqSetOrderExpiration(_ticket, 48);
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.25);
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 125);
