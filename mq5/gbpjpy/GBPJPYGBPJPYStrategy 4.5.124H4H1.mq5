...
input string CustomComment = "GBPJPYStrategy 4.5.124H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22355;        //MagicNumber
...
input double ProfitTarget1 = 260;        //ProfitTarget1
input double StopLoss1 = 115;        //StopLoss1
input double TrailingStopCoef1 = 2;        //TrailingStopCoef1
input int Period1 = 55;        //Period1
input double ProfitTarget2 = 5.8;        //ProfitTarget2
input double StopLoss2 = 1.2;        //StopLoss2
input double TrailingStopCoef2 = 4.9;        //TrailingStopCoef2
...
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 35)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "GBPJPYStrategy 4.5.124H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqWeekly(NULL,0, "High", 1), 6) >= NormalizeDouble((double) sqOpen(NULL,0, 1), 6));

     ShortEntrySignal = ((sqOpen("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2+1))
      &&   (NormalizeDouble((double) sqMonthly(NULL,0, "Open", 2), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "Open", 1), 6)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 1, StopLoss2), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 15);
