...
input string CustomComment = "GBPJPYStrategy 3.7.134H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22353;        //MagicNumber
...
input int SchaffTrnCycLvlStcPrd1 = 97;        //SchaffTrnCycLvlStcPrd1
input int SchaffTrnCycLvlFstPrd1 = 30;        //SchaffTrnCycLvlFstPrd1
input int SchaffTrnCycLvlSlwPrd1 = 46;        //SchaffTrnCycLvlSlwPrd1
input int BBBarOpensPeriod1 = 20;        //BBBarOpensPeriod1
input double ProfitTarget1 = 3.6;        //ProfitTarget1
input double StopLoss1 = 1.5;        //StopLoss1
input int Period1 = 10;        //Period1
input double ProfitTarget2 = 7.5;        //ProfitTarget2
input double StopLoss2 = 185;        //StopLoss2
input double TrailingStop1 = 70;        //TrailingStop1
input int Period2 = 100;        //Period2
...
#define SCHAFFTRENDCYCLE_1 0     //iCustom(NULL,0, "SqSchaffTrendCycle", SchaffTrnCycLvlStcPrd1,SchaffTrnCycLvlFstPrd1,SchaffTrnCycLvlSlwPrd1)
#define BOLLINGERBANDS_1 1     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_HIGH)
#define HIGHEST_1 2     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period2, PRICE_CLOSE)
...
string sqStrategyName = "GBPJPYStrategy 3.7.134H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqGetIndicatorValue(SCHAFFTRENDCYCLE_1, 2)>27.3)
      &&   (NormalizeDouble((double) sqDaily(NULL,0, "High", 3), 6) >= NormalizeDouble((double) sqDaily(NULL,0, "High", 2), 6)));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 200);
...
bool initIndicators(){
   ...
   indicatorHandles[SCHAFFTRENDCYCLE_1] = iCustom(NULL,0, "SqSchaffTrendCycle", SchaffTrnCycLvlStcPrd1,SchaffTrnCycLvlFstPrd1,SchaffTrnCycLvlSlwPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.1, PRICE_HIGH);
