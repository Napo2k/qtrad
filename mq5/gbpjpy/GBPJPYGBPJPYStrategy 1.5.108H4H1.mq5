...
input string CustomComment = "GBPJPYStrategy 1.5.108H4";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 22347;        //MagicNumber
...
input double ProfitTarget1 = 490;        //ProfitTarget1
input double StopLoss1 = 1.1;        //StopLoss1
input double TrailingStop1 = 80;        //TrailingStop1
input double TrailingActivation1 = 50;        //TrailingActivation1
input int Period1 = 35;        //Period1
input double ProfitTarget2 = 6.8;        //ProfitTarget2
input double StopLoss2 = 125;        //StopLoss2
input double TrailingStopCoef1 = 2.5;        //TrailingStopCoef1
input double TrailingActCef1 = 4.9;        //TrailingActCef1
...
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 110)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 5)
...
string sqStrategyName = "GBPJPYStrategy 1.5.108H4";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "Low", 3), 6) <= NormalizeDouble((double) sqDaily(NULL,0, "Open", 2), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "Close", 2), 6) < NormalizeDouble((double) sqClose(NULL,0, 1), 6));
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 110);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 5);
