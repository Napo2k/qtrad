...
input string CustomComment = "Strategy_2_10_146";
...
input int KCBarOpenserPeriod1 = 30;        //KCBarOpenserPeriod1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.6)
...
string sqStrategyName = "Strategy 2.10.146";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 1) < sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1+1));

     ShortEntrySignal = (sqOpen("NULL",0, 1) > sqGetIndicatorValue(KELTNERCHANNEL_1, 1, 1+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqHigh(NULL,0, 3) - (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 66);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqLow(NULL,0, 3) + (PriceEntryMult1 * sqBarRange("NULL",0, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KCBarOpenserPeriod1, 2.6);
